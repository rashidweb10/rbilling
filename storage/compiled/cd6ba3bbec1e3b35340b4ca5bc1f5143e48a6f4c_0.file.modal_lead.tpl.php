...
function content_63d370814f3872_68457349 (Smarty_Internal_Template $_smarty_tpl) {
?><div>
                    ...
                    <form class="form-horizontal" id="ib_modal_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3"><label for="status"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Status'];?>
</label>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                    ...
                                    <div class="col-md-5">
                                        <div class="mb-3"><label for="first_name"><?php echo $_smarty_tpl->tpl_vars['_L']->value['First Name'];?>
</label>
...
">
                                    ...
                                    <div class="col-md-5">
                                        <div class="mb-3"><label for="last_name"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Last Name'];?>
...
">
                                ...
                                <div class="mb-3"><label for="title"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Title'];?>
</label>
                                    <input type="text" id="title" name="title" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['val']->value['title'];?>
">
                                </div>

                                <div class="mb-3"><label for="company"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Company'];?>
</label>
...
">
                                ...
                                <div class="mb-3"><label for=""><?php echo $_smarty_tpl->tpl_vars['_L']->value['Phone'];?>
</label>
...
">
                                ...
                                <div class="mb-3"><label for="source"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Source'];?>
</label>
...
"
                                            <?php if ($_smarty_tpl->tpl_vars['val']->value['source'] == $_smarty_tpl->tpl_vars['source']->value['sname']) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['source']->value['sname'];?>
</option>
                                        <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                ...
                                <div class="mb-3"><label for="industry"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Industry'];?>
</label>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                ...
                                <fieldset>
                                    ...
                                    <div class="mb-3"><label for="street"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Street'];?>
</label>
...
">
                                ...
                                <fieldset class="mt-3">
                                    ...
                                    <div class="mb-3"><label for="memo"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Memo'];?>
</label>
