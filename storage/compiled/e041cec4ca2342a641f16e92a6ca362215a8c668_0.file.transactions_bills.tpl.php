...
function content_643069d14c06c7_01210529 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_1943376566643069d146d291_83586930', "content");
?>



<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_960369538643069d14bf0c1_91146372', "script");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_admin']->value));
}
/* {block "content"} */
class Block_1943376566643069d146d291_83586930 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_1943376566643069d146d291_83586930',
  ),
);
...
" class="btn btn-primary btn-icon btn-sm" data-bs-toggle="tooltip" data-placement="top" title="View"><i class="fal fa-pencil"></i></a>
                                                                    <?php if ($_smarty_tpl->tpl_vars['bill']->value->website != '') {?>
                                                                        <a href="<?php echo $_smarty_tpl->tpl_vars['bill']->value->website;?>
" target="_blank" class="btn btn-dark btn-icon btn-sm" data-bs-toggle="tooltip" data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['bill']->value->website;?>
...
');" class="btn btn-danger btn-sm btn-icon" data-bs-toggle="tooltip" data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['_L']->value['Delete'];?>
...
');" class="btn btn-success btn-sm btn-icon" data-bs-toggle="tooltip" data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['_L']->value['Mark as Paid'];?>
                                                        ...
                                                        <div class="ibox-content">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 text-end">
                                                                    <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
transactions/bill/<?php echo $_smarty_tpl->tpl_vars['bill']->value->id;?>
" class="btn btn-primary btn-icon" data-bs-toggle="tooltip" data-placement="top" title="View"><i class="fal fa-file-text-o"></i></a>
                                                                    <?php if ($_smarty_tpl->tpl_vars['bill']->value->website != '') {?>
                                                                        <a href="<?php echo $_smarty_tpl->tpl_vars['bill']->value->website;?>
" target="_blank" class="btn btn-dark btn-icon" data-bs-toggle="tooltip" data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['bill']->value->website;?>
"><i class="fal fa-globe"></i></a>
                                                                    <?php }?>
                                                                    <a href="javascript:;" onclick="confirmThenGoToUrl(event,'transactions/delete-bill/<?php echo $_smarty_tpl->tpl_vars['bill']->value->id;?>
');" class="btn btn-danger btn-xs" data-bs-toggle="tooltip" data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['_L']->value['Delete'];?>
"><i class="fal fa-trash"></i></a>
                                                                    <?php if ($_smarty_tpl->tpl_vars['bill']->value->is_paid == 0) {?>
                                                                        <a href="javascript:;" onclick="confirmThenGoToUrl(event,'transactions/bill-mark-as-paid/<?php echo $_smarty_tpl->tpl_vars['bill']->value->id;?>
');" class="btn btn-green btn-xs" data-bs-toggle="tooltip" data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['_L']->value['Mark as Paid'];?>
"><i class="fal fa-check"></i></a>
                                                                    <?php }?>
                                                                </div>
                                                            </div>
...
/* {/block "content"} */
/* {block "script"} */
class Block_960369538643069d14bf0c1_91146372 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_960369538643069d14bf0c1_91146372',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
