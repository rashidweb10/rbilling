<?php
/* Smarty version 4.3.0, created on 2024-08-15 09:14:13
  from 'C:\xampp\htdocs\cloudonex-business-suit\ui\theme\default\invoice.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_66bdff25ef8601_44528172',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0ec5a2a305eea834a702d9aba42ec74cfcbbd290' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cloudonex-business-suit\\ui\\theme\\default\\invoice.tpl',
      1 => 1685172824,
      2 => 'file',
    ),
  ),
...
function content_66bdff25ef8601_44528172 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_85310729266bdff25ccae46_36266217', "head");
?>



<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_209554166466bdff25cd6182_11805257', "content");
?>



<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_142593021666bdff25eae0d2_95620858', "script");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_admin']->value));
}
/* {block "head"} */
class Block_85310729266bdff25ccae46_36266217 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'head' => 
  array (
    0 => 'Block_85310729266bdff25ccae46_36266217',
  ),
);
...
/* {/block "head"} */
/* {block "content"} */
class Block_209554166466bdff25cd6182_11805257 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_209554166466bdff25cd6182_11805257',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
if ($_smarty_tpl->tpl_vars['invoice']->value->cn != '') {?> <?php echo $_smarty_tpl->tpl_vars['invoice']->value->cn;?>
 ...
 <?php }?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['action']->value === 'credit-note') {?>
                                    <?php echo predict_next_serial($_smarty_tpl->tpl_vars['config']->value,'credit-note');?>
...
}?> <?php if ($_smarty_tpl->tpl_vars['cs']->value['code']) {?>[<?php echo $_smarty_tpl->tpl_vars['cs']->value['code'];?>
]<?php }?> </option>
                                                    <?php
}
                                        ...
                                        <div class='col-sm-4'>
                                            <div class='mb-3'>
                                                ...
                                                <select class="form-select" name="aid" id="aid">
                                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['staffs']->value, 'owner');
...
"
                                                                <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>
                                                                <?php if ($_smarty_tpl->tpl_vars['invoice']->value->aid == $_smarty_tpl->tpl_vars['owner']->value->id) {?>selected="selected"<?php }?>
                                                            <?php } else { ?>
                                                            <?php if ($_smarty_tpl->tpl_vars['owner']->value->id == $_smarty_tpl->tpl_vars['user']->value->id) {?>selected<?php }?>
                                                        <?php }?> ><?php echo $_smarty_tpl->tpl_vars['owner']->value->fullname;?>
</option>
                                                    <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
" <?php }?>>
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class='col-sm-4'>
                                            <div class="mb-3">
                                                <label for="invoicenum"><?php echo __('Prefix');?>
</label>
...
"><?php echo $_smarty_tpl->tpl_vars['config']->value['business_location'];?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                <label for="idate"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Date'];?>
</label>
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="2">
                                                ...
                                                <?php if ($_smarty_tpl->tpl_vars['invoice']->value) {?>
                                                    ...
                                                    <label class="radio-inline">
                                                        <input class="discountType" id="discountTypeP" type="radio" name="discount_type" value="p" <?php if ($_smarty_tpl->tpl_vars['invoice']->value->discount_type == 'p') {?>checked<?php }?>> <span  data-bs-toggle="tooltip" data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['_L']->value['Percentage'];?>
">%</span>
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input class="discountType" id="discountTypeF" type="radio" name="discount_type" value="f" <?php if ($_smarty_tpl->tpl_vars['invoice']->value->discount_type == 'f') {?>checked<?php }?>> <span data-bs-toggle="tooltip" data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['_L']->value['Fixed Amount'];?>
...
">%</span>
                                                    ...
                                                    <label class="radio-inline">
                                                        <input class="discountType" id="discountTypeF" type="radio" name="discount_type" value="f"> <span data-bs-toggle="tooltip" data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['_L']->value['Fixed Amount'];?>
" id="fixedDiscountText">
                                                    <?php if ((isset($_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['config']->value['home_currency']]))) {?>
                                                        <?php echo $_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['config']->value['home_currency']]['symbol'];?>
...
/* {/block "content"} */
/* {block "script"} */
class Block_142593021666bdff25eae0d2_95620858 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_142593021666bdff25eae0d2_95620858',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
