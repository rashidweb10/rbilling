...
/* Smarty version 4.3.0, created on 2024-09-29 18:32:58
  from 'C:\xampp\htdocs\cloudonex-business-suit\ui\theme\default\feature-settings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_66f95002f03065_28193516',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'db7ea173678e730320f8ba5649349cb6edc43b73' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cloudonex-business-suit\\ui\\theme\\default\\feature-settings.tpl',
      1 => 1685172824,
      2 => 'file',
    ),
  ),
...
function content_66f95002f03065_28193516 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_187537508966f95002dcc587_60422516', "content");
?>


<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_203347059366f95002eac4b1_81722577', "script");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_admin']->value));
}
/* {block "content"} */
class Block_187537508966f95002dcc587_60422516 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_187537508966f95002dcc587_60422516',
  ),
);
...
?>
 ...
 - <?php echo $_smarty_tpl->tpl_vars['_L']->value['Show Business Number'];?>
                            ...
                            <tr>
                                <td width="80%"><label class="font-weight-bold" for="config_invoicing_allow_staff_selection_for_each_item"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Invoicing'];?>
 - <?php ob_start();
echo __('Allow staff selection for each item');
$_prefixVariable1 = ob_get_clean();
echo $_prefixVariable1;?>
</label></td>
                                <td>
                                    <label class="switch s-icons s-outline s-outline-primary">
                                        <input type="checkbox" id="config_invoicing_allow_staff_selection_for_each_item" <?php if (get_option('invoicing_allow_staff_selection_for_each_item') == '1') {?>checked<?php }?>>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                            </tr>
...
">
                            ...
                            <tr>
                                <td width="80%"><label class="font-weight-bold" for="config_invoice_show_qr_code"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Invoicing'];?>
 - <?php echo __('QR Code');?>
</label></td>
                                <td>
                                    <label class="switch s-icons s-outline s-outline-primary">
                                        <input type="checkbox" id="config_invoice_show_qr_code" <?php if (get_option('invoice_show_qr_code') == '1') {?>checked<?php }?>>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td width="80%"><label class="font-weight-bold" for="config_invoice_items_shipping"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Invoicing'];?>
 - <?php echo __('Shipping');?>
</label></td>
                                <td>
                                    <label class="switch s-icons s-outline s-outline-primary">
                                        <input type="checkbox" id="config_invoice_items_shipping" <?php if (get_option('invoice_items_shipping') == '1') {?>checked<?php }?>>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td width="80%"><label class="font-weight-bold" for="config_invoice_items_purchasing"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Invoicing'];?>
 - <?php echo __('Purchase');?>
</label></td>
                                <td>
                                    <label class="switch s-icons s-outline s-outline-primary">
                                        <input type="checkbox" id="config_invoice_items_purchasing" <?php if (get_option('invoice_items_purchasing') == '1') {?>checked<?php }?>>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td width="80%"><label class="font-weight-bold" for="config_invoice_group"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Invoicing'];?>
 - <?php echo __('Group');?>
</label></td>
                                <td>
                                    <label class="switch s-icons s-outline s-outline-primary">
                                        <input type="checkbox" id="config_invoice_group" <?php if (get_option('invoice_group') == '1') {?>checked<?php }?>>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td width="80%"><label class="font-weight-bold" for="config_invoice_single_service"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Invoicing'];?>
 - <?php echo __('Single Service');?>
</label></td>
                                <td>
                                    <label class="switch s-icons s-outline s-outline-primary">
                                        <input type="checkbox" id="config_invoice_single_service" <?php if (get_option('invoice_single_service') == '1') {?>checked<?php }?>>
                                        <span class="slider round"></span>
                                    </label>
                                </td>
                            </tr>
...
/* {/block "content"} */
/* {block "script"} */
class Block_203347059366f95002eac4b1_81722577 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_203347059366f95002eac4b1_81722577',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
