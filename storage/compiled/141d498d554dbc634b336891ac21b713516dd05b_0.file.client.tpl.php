...
function content_63d378af005a69_41330844 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, true);
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_136747519163d378aef17b13_33481400', 'head_extras_from_layout');
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_163261440363d378aef1bfe5_45174123', "content_body");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, "hostbilling/layouts/base.tpl");
}
/* {block 'head_extras_from_layout'} */
class Block_136747519163d378aef17b13_33481400 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'head_extras_from_layout' => 
  array (
    0 => 'Block_136747519163d378aef17b13_33481400',
  ),
);
...
?>
    ...
    <style>
        html body a {
            color: <?php echo (($tmp = $_smarty_tpl->tpl_vars['config']->value['frontend_link_color'] ?? null)===null||$tmp==='' ? '#7367f0' ?? null : $tmp);?>
;;
        }
        .dropdown-item:hover, .dropdown-item:focus {
            color: <?php echo (($tmp = $_smarty_tpl->tpl_vars['config']->value['frontend_primary_button_hover_color'] ?? null)===null||$tmp==='' ? '#0069d9' ?? null : $tmp);?>
;
        }
        .form-control:focus {
            border-color: <?php echo (($tmp = $_smarty_tpl->tpl_vars['config']->value['frontend_primary_button_hover_color'] ?? null)===null||$tmp==='' ? '#7367f0' ?? null : $tmp);?>
;
        }
        .bg-primary {
            background-color: <?php echo (($tmp = $_smarty_tpl->tpl_vars['config']->value['frontend_primary_button_color'] ?? null)===null||$tmp==='' ? '#7367f0' ?? null : $tmp);?>
 !important;
        }
        a:hover {
            color: <?php echo (($tmp = $_smarty_tpl->tpl_vars['config']->value['frontend_primary_button_hover_color'] ?? null)===null||$tmp==='' ? '#887ef2' ?? null : $tmp);?>
;
        }
    </style>
<?php
...
/* {/block 'head_extras_from_layout'} */
/* {block "content"} */
class Block_3629403463d378af002f27_69225451 extends Smarty_Internal_Block
{
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
}
}
/* {/block "content"} */
/* {block "content_body"} */
class Block_163261440363d378aef1bfe5_45174123 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content_body' => 
  array (
    0 => 'Block_163261440363d378aef1bfe5_45174123',
  ),
  'content' => 
  array (
    0 => 'Block_3629403463d378af002f27_69225451',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
/ui/theme/default/img/cover-2-lg.png" class="cover" alt="cover">
            ...
            <ul id="clx-navigation-menu" class="nav-menu">
                ...
                <li <?php if ($_smarty_tpl->tpl_vars['selected_navigation']->value == 'home') {?>class="active"<?php }?>><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
client">
...
client/domain-register/">
                ...
                <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['kb'])) && $_smarty_tpl->tpl_vars['config']->value['kb'] == '1') {?>
...
">
                                    ...
                                    <div class="info-card-text">
                                        ...
                                        <span class="text-truncate text-truncate-md opacity-80"><?php echo $_smarty_tpl->tpl_vars['user']->value->email;?>
</span>
                                    </div>
                                </div>
                            </div>
...
echo $_smarty_tpl->tpl_vars['notify']->value;
            ...
            <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_3629403463d378af002f27_69225451', "content", $this->tplIndex);
?>
