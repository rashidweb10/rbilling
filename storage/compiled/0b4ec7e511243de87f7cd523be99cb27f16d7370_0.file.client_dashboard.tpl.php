...
function content_643faf57ae5f42_73427925 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_1469759501643faf57a05505_16690223', "content");
?>


<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_1775201835643faf57ad91b1_74041490', "script");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_client']->value));
}
/* {block "content"} */
class Block_1469759501643faf57a05505_16690223 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_1469759501643faf57a05505_16690223',
  ),
);
...
">
                            ...
                            <h3 class="h2 mt-3"><?php echo $_smarty_tpl->tpl_vars['user']->value->account;?>
</h3>
...
: <span class="amount text-success"><?php echo $_smarty_tpl->tpl_vars['user']->value->balance;?>
                                ...
                                <hr>
                                <a href="javascript:void(0)" class="btn btn-primary add_fund"><i class="fal fa-plus"></i> <?php ob_start();
echo __('Add Fund');
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 <br>
        ...
        <div class="col-md-8">
            <div class="panel">
                <div class="panel-hdr">
                    <h5><?php echo $_smarty_tpl->tpl_vars['_L']->value['Recent Orders'];?>
</h5>
                </div>
 ...
 "><?php echo $_smarty_tpl->tpl_vars['order']->value->amount;?>
                                        ...
                                        <td>
                                            <?php if ($_smarty_tpl->tpl_vars['order']->value->status == 'Active') {?>
                                                <span class="badge badge-outline-success"><?php echo ib_lan_get_line($_smarty_tpl->tpl_vars['_L']->value[$_smarty_tpl->tpl_vars['order']->value->status]);?>
</span>
                                            <?php } else { ?>
                                                <span class="badge badge-outline-danger"><?php echo ib_lan_get_line($_smarty_tpl->tpl_vars['_L']->value[$_smarty_tpl->tpl_vars['order']->value->status]);?>
</span>
                                            <?php }?>
                                        </td>
                                    </tr>
...
?>
                                    <tr class="<?php if ($_smarty_tpl->tpl_vars['ds']->value['cr'] == '0.00') {?>table-warning <?php } else { ?>table-info<?php }?>">
                                        ...
                                        <td class="text-end amount"><?php echo $_smarty_tpl->tpl_vars['ds']->value['amount'];?>
</td>
...
if ($_smarty_tpl->tpl_vars['ds']->value['cn'] != '') {?> <?php echo $_smarty_tpl->tpl_vars['ds']->value['cn'];?>
 ...
 <?php }?></a> </td>
                                        ...
                                        <td class=" h6"><?php echo $_smarty_tpl->tpl_vars['ds']->value['title'];?>
 </td>
 ...
 <?php } else { ?> <?php echo $_smarty_tpl->tpl_vars['ds']->value['currency_symbol'];
                                        ...
                                        <td>
                                            ...
                                            <?php if ($_smarty_tpl->tpl_vars['ds']->value['status'] == 'Unpaid') {?>
                                                <span class="badge badge-outline-danger"><?php echo ib_lan_get_line($_smarty_tpl->tpl_vars['ds']->value['status']);?>
</span>
                                            <?php } elseif ($_smarty_tpl->tpl_vars['ds']->value['status'] == 'Paid') {?>
                                                <span class="badge badge-outline-success"><?php echo ib_lan_get_line($_smarty_tpl->tpl_vars['ds']->value['status']);?>
</span>
                                            <?php } elseif ($_smarty_tpl->tpl_vars['ds']->value['status'] == 'Partially Paid') {?>
                                                <span class="badge badge-outline-info"><?php echo ib_lan_get_line($_smarty_tpl->tpl_vars['ds']->value['status']);?>
</span>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="panel">
                <div class="panel-hdr">
                    <h5><?php echo $_smarty_tpl->tpl_vars['_L']->value['Recent Quotes'];?>
</h5>
                </div>
                <div class="panel-container">
                    <div class="panel-content">
...
/* {/block "content"} */
/* {block "script"} */
class Block_1775201835643faf57ad91b1_74041490 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_1775201835643faf57ad91b1_74041490',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
